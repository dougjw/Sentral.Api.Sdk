...
{
    [Cmdlet(VerbsData.Export,"SntEnrStudentPhoto", DefaultParameterSetName = _singularParamSet)]
    public class ExportSntEnrStudentPhoto : SentralPSCmdlet
    {
        ...
        private void ProcessParamsSingular()
        {
            ...
            var studentPhoto = SentralApiClient.Enrolments.GetStudentPhoto(StudentId, Width, Height);
