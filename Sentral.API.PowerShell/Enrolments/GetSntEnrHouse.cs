...
{
    [Cmdlet(VerbsCommon.Get, "SntEnrHouse", DefaultParameterSetName = _singularParamSet)]
    [OutputType(typeof(EnrolmentPriority))]
    public class GetSntEnrHouse : SentralPSCmdlet
    {
        ...
        {
            WriteObject(
                    SentralApiClient.Enrolments.GetHouse(HouseIds)
                );
        }
